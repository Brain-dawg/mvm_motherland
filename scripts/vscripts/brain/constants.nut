...
// Wavebar netprops
const STRING_NETPROP_CLASSNAMES = "m_iszMannVsMachineWaveClassNames"
const STRING_NETPROP_FLAGS      = "m_nMannVsMachineWaveClassFlags"
const STRING_NETPROP_COUNTS     = "m_nMannVsMachineWaveClassCounts"
...
// shorthand versions
const ICON_NORMAL          = 1
const ICON_SUPPORT         = 2
const ICON_MISSION         = 4
const ICON_MINIBOSS        = 8
const ICON_ALWAYSCRIT      = 16
const ICON_SUPPORT_LIMITED = 32
