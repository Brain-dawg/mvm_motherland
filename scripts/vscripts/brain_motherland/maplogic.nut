...
// AddOutput( altbomb, "OnDrop",   "flag_bomb_flank", "RunScriptCode", "FakeBomb( false, true )", 0, -1)
// AddOutput( altbomb, "OnPickup", "flag_bomb_flank", "RunScriptCode", "FakeBomb( true, true )", 0, -1)
// AddOutput( altbomb, "OnReturn", "flag_bomb_flank", "RunScriptCode", "FakeBomb( false, true )", 0, -1)