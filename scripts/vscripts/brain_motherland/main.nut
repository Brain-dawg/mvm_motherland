IncludeScript( "brain_motherland/constants.nut" )
...
_MotherlandMain.PointBDoor   <- FindByName( null, "pointB_door" )
_MotherlandMain.GateBDoor    <- FindByName( null, "pointA_spawn_door" )
...
IncludeScript( "brain_motherland/event_wrapper.nut" )
IncludeScript( "brain_motherland/utils.nut" )
IncludeScript( "brain_motherland/wavebar.nut" )
IncludeScript( "brain_motherland/tags.nut" )
IncludeScript( "brain_motherland/maplogic.nut" )
